...
poll = LinePoll(cl)
call = cl
creator = ["u8a6049ae83629033334864657a4cb506"] # ᴍɪᴅ ᴄʀᴇᴀᴛᴏʀ ᴊᴀɴɢᴀɴ ᴅɪ ᴜʙᴀʜ ʙᴏs
...
def help():
    ...
    helpMessage = "╭━━━━━━━━━━━━━━━━━━━━━\n" + \
                  ...
                  "║│" + key + "ᴀᴅᴍɪɴᴀᴅᴅ @\n" + \
                  "║│" + key + "ᴀᴅᴍɪɴᴅᴇʟʟ @\n" + \
                  "║│" + key + "ᴩʀᴏᴛᴇᴄᴛᴋɪᴄᴋ ᴏɴ/ᴏғғ\n" + \
                  "║│" + key + "ᴩʀᴏᴛᴇᴄᴛᴊᴏɪɴ ᴏɴ/ᴏғғ\n" + \
                  "║│" + key + "ᴩʀᴏᴛᴇᴄᴛɪɴᴠɪᴛᴇ ᴏɴ/ᴏғғ\n" + \
                  "║│" + key + "ᴩʀᴏᴛᴇᴄᴛᴜʀʟ ᴏɴ/ᴏғғ\n" + \
                  "║│" + key + "ɢʜᴏsᴛ ᴏɴ/ᴏғғ\n" + \
                  "║│" + key + "ʙᴏᴛ 1,2,3,4 ᴜᴩ\n" + \
                  "║│" + key + "ᴩʀᴏ ᴏɴ/ᴏғғ\n" + \
                  "║│" + key + "ᴀɴᴛɪᴊs ᴏɴ/ᴏғғ\n" + \
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                cl.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid])
                                ki.acceptGroupInvitation(op.param1)
                                kk.acceptGroupInvitation(op.param1)
                                kc.acceptGroupInvitation(op.param1)
                                kb.acceptGroupInvitation(op.param1)
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        cl.kickoutFromGroup(op.param1,[op.param2])
                                        cl.inviteIntoGroup(op.param1,[Dmid,Amid,Bmid,Cmid,Emid])
                                        kc.acceptGroupInvitation(op.param1)
                                        ki.acceptGroupInvitation(op.param1)
                                        kk.acceptGroupInvitation(op.param1)
                                        kb.acceptGroupInvitation(op.param1)
               ...
               if msg.contentType == 0:
                 ...
                 if text is None:
                     return
                        ...
                        if cmd == "self on":
                         ...
                         if wait["selfbot"] == True:
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"ʏᴀɴɢ ᴋᴇᴄᴇ ᴋᴏɴᴛᴀᴋ ɴʏᴀ ᴀᴅᴀ ᴅɪ ʙᴀᴡᴀʜ") 
                        ...
                        elif text.lower() == 'mksih':
                        	   cl.sendMessage(msg.to, "ɪʏᴀ ᴋᴀ sᴀᴍᴀ sᴀᴍᴀ..")                        
                        elif text.lower() == 'terima kasih':
                        	   cl.sendMessage(msg.to, "sᴀᴍᴀ sᴀᴍᴀ ᴋᴋ..")                        
                        elif text.lower() == 'bot':
                        	   cl.sendMessage(msg.to, "ᴀᴩᴀ sɪʜ ʟᴜ ᴍᴀɴɢɢɪʟ ᴍᴀɴɢɢɪʟ ᴍᴜʟᴜ..??")
                        elif text.lower() == 'sepi':
                        	   cl.sendMessage(msg.to, "ᴋᴀʟᴀᴜ ɢᴋ ᴀᴅᴀ ʙᴏᴛ ʀᴏᴏᴍ ʙᴀᴋᴀʟᴀɴ sᴇᴩɪ ʏᴇ ᴋᴀɴ..??")
                        elif text.lower() == 'naik':
                        	   cl.sendMessage(msg.to, "ᴊᴀɴɢᴀɴ ᴍᴀᴜ ᴋᴀ ᴅɪ ᴀᴛᴀs ʙᴀɴʏᴀᴋ ɴʏᴀᴍᴜᴋ..!l")
                        elif text.lower() == 'up':
                        	   cl.sendMessage(msg.to, "ᴊɢɴ ᴍᴀᴜ ᴋᴀ ᴅɪ ᴀᴛᴀs ʟɢɪ ᴩᴀᴅᴀ ᴄᴏʏᴀʜ ᴡᴋᴋᴡᴋᴡ")
                           ...
                           if msg._from in Bots:
                            if msg.toType == 2:
                             #  print "Otw cleanse"
                               ...
                               ki.sendMessage(to, "ʜᴀʜᴀʜ")
                               kk.sendMessage(to, "ᴜᴅᴀʜ ᴍᴜʟᴀɪ ᴩᴀɴɪᴋ")
                               kk.sendMessage(msg.to,"ᴄʟᴇᴀʀ ᴀʟʟ")
                          ...
                          if msg._from in admin:
                           ...
                           if msg._from in admin:
                            ...
                            if msg._from in admin:
                               ...
                               with requests.session() as web:
                                   web.headers["User-Agent"] = random.choice(settings["userAgent"])
                                   result = web.get("http://api.zicor.ooo/joox.php?search={}".format(str(search)))
                                   data = result.text
                                   data = json.loads(data)
                                   if len(cond) == 1:
                                      num = 0
                                   ...
                                   if len(cond) == 2:
                                        ...
                                        if num <= len(data["result"]):
                                               ...
                                               with requests.session() as web:
                                                    web.headers["User-Agent"] = random.choice(settings["userAgent"])
                                                    result = web.get("http://api.zicor.ooo/joox/song.php?sid={}".format(str(music["sid"])))
                                                    data = result.text
                                                    data = json.loads(data)
                                                    if data["result"] != []:
                                                         ret_ = "「 Pencarian Musik 」"
